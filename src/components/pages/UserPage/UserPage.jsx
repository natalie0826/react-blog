    ...
    return (
        ...
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            ...
            <div className="post-horizontal-container">
                ...
                {/* <PostCard isHorizontal comments="12" minutes="15" image="https://images.unsplash.com/photo-1505330622279-bf7d7fc918f4?ixlib=rb-0.3.5&s=56f62ac759295d695dd71968a3898038&auto=format&fit=crop&w=1350&q=80" /> */}
            </div>
    }
            ...
            <div className="post-horizontal-container">
                ...
                <div className="post-horizontal">
                    <h1 className="post-horizontal-title">Try to implement new features in your code</h1>
                    <div className="info__subtitle">
                        <span>Bobby Cassana</span>
                        <span> - </span>
                        <span className="info__subtitle--light">02 MAY 2017</span>
                    </div>
