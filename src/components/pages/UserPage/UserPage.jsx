...
export default class UserPage extends React.Component {
    ...
    addInfo = () => {
        this.setState((prevState, props) => { return {showStepper: !prevState.showStepper}})
    }
            ...
            <Col xs={24} sm={24} md={24} lg={16} xl={16}>
                {this.state.showStepper ?
                    ...
                    <div>
                        ...
                        {!this.props.posts || this.props.posts.getIn([-1, 'isFetching']) !== 'finish' ?
                        <Spin />:this.props.posts.getIn([-1, 'posts']).map(post => {
